          ...
          <div className="flex-shrink-0 flex items-center">
            <Link href="/" className="font-bold text-3xl text-black">
              <span className="flex items-center">
                DS
                <div className="ml-2 bg-white p-2 shadow-md rounded-md">
            ...
            <div className="ml-10 flex items-center space-x-4">
              {navLinks.map((link) => (
                <Link 
                  key={link.href}
                  href={link.href}
                  className="group relative text-black border border-black px-3 py-2 text-sm font-medium overflow-hidden"
                >
